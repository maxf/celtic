...
function Graph(params) {
  ...
  case Graph.TYPE_TRIANGLE:
    ...
    var p2x = (cx-L * Math.SQRT_3/2.0), p2y = (cy + L/2.0); /* p2 is the bottom left vertex */
    var nsteps = Math.floor(3 * L/(Math.SQRT_3 * edge_size)) | 0;
...
var Celtic = (function () {
  ...
  return function (params) {
    var
      ...
      angle, /* angle of rotation of the graph around the centre */
      canvas,
      width, height,
